...
def chunk_articles(articles: list[Article], chunk_size: int, chunk_overlap: int) -> list[Document]:
    ...
    for article in articles:
        ...
        try:
            ...
            for i, chunk_text in enumerate(chunks):
                document = Document(
                    page_content=context_prefix + chunk_text,
                    metadata={
                        "chunk_id": f"{article.id}#chunk_{i}",
